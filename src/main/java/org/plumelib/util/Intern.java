...
public final class Intern {
  ...
  @SuppressWarnings({"determinism:invalid.array.component.type",  // null is treated as Det (array invariance)
          "determinism:argument.type.incompatible","determinism:return.type.incompatible","determinism:method.invocati  on.invalid"  // Cannot declare as PolyDet: internedIntSubsequence
  })
